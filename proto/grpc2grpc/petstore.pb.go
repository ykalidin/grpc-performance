...
type User struct {
	...
	Timestmp             int64    `protobuf:"varint,5,opt,name=timestmp,proto3" json:"timestmp,omitempty"`
	Timestmp2            int64    `protobuf:"varint,6,opt,name=timestmp2,proto3" json:"timestmp2,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *User) GetTimestmp2() int64 {
	if m != nil {
		return m.Timestmp2
	}
	return 0
